    ...
    <v-container >
        <v-layout row >
            <v-flex xs12 sm6 offset-sm3>
                <h2 color="blue"> Create New Meet UP</h2>
            </v-flex>
        </v-layout>
        <v-layout row>
            <v-flex xs12>
     <form  @submit.prevent="onCreateMeetup">
        ...
        <v-layout row>
         ...
         <v-layout row>
             <v-flex xs12 sm6 offset-sm3>
                 <v-btn raised color="red" @click="onPickFile" >Upload Image</v-btn>
                <input 
                type="file" 
                style="display: none" 
                ref="fileInput"
        ...
        <v-layout row class="md-2">
            <v-flex xs12 xm6 offset-sm3>
                <v-date-picker v-modal="date"> </v-date-picker>              
            </v-flex>
        </v-layout>
        <v-layout row>
            <v-flex xs12 xm6 offset-sm3>
                <v-time-picker  v-modal="time" format="24hr"></v-time-picker>             
            </v-flex>
        </v-layout>
        <v-layout row>
            <v-flex  xs12 sm6 offset-sm3>
                <v-btn color="red" :disabled="!formIsValid" 
